...
public class CJouer10 {
	...
	public void initMot() throws Exception {
		...
		Path path = Paths.get("ressources/BDD_Motus10.csv");
		...
		switch (compteur) {
			case 0:
				...
				try {
					...
					l90.setText(tentativeFx.getText().substring(9, 10));
			...
			case 1:
				...
				try {
					...
					l91.setText(tentativeFx.getText().substring(9, 10));
			...
			case 2:
				...
				try {
					...
					l92.setText(tentativeFx.getText().substring(9, 10));
			...
			case 3:
				...
				try {
					...
					l93.setText(tentativeFx.getText().substring(9, 10));
			...
			case 4:
				...
				try {
					...
					l94.setText(tentativeFx.getText().substring(9, 10));
			...
			case 5:
				...
				try {
					...
					l95.setText(tentativeFx.getText().substring(9, 10));
	...
	public void setMotAdverse() {
		...
		if(tentative.length() == 7) {
			...
			l9Adverse.setText(tentativeFx.getText().substring(9, 10));
	...
	void couleurLabel(int compteur, int colonne, String typeErreur) {
		...
		case 1:
			...
			case 9:
				if(typeErreur == "bon") {l90.setStyle("-fx-background-color: blue;");}
				if(typeErreur == "place") {l90.setStyle("-fx-background-color: yellow;");
					l90.setTextFill(Color.BLACK);}
				if(typeErreur == "faux") {l90.setStyle("-fx-background-color: red;");}
				break;		
			}
		case 2:
			switch(colonne) {
			...
			case 9:
				if(typeErreur == "bon") {l91.setStyle("-fx-background-color: blue;");}
				if(typeErreur == "place") {l91.setStyle("-fx-background-color: yellow;");
					l91.setTextFill(Color.BLACK);}
				if(typeErreur == "faux") {l91.setStyle("-fx-background-color: red;");}
				break;	
			}
		case 3:
			switch(colonne) {
			...
			case 9:
				if(typeErreur == "bon") {l92.setStyle("-fx-background-color: blue;");}
				if(typeErreur == "place") {l92.setStyle("-fx-background-color: yellow;");
					l92.setTextFill(Color.BLACK);}
				if(typeErreur == "faux") {l92.setStyle("-fx-background-color: red;");}
				break;	
			}
		case 4:
			switch(colonne) {
			...
			case 9:
				if(typeErreur == "bon") {l93.setStyle("-fx-background-color: blue;");}
				if(typeErreur == "place") {l93.setStyle("-fx-background-color: yellow;");
					l93.setTextFill(Color.BLACK);}
				if(typeErreur == "faux") {l93.setStyle("-fx-background-color: red;");}
				break;	
			}
		case 5:
			switch(colonne) {
			...
			case 9:
				if(typeErreur == "bon") {l94.setStyle("-fx-background-color: blue;");}
				if(typeErreur == "place") {l94.setStyle("-fx-background-color: yellow;");
					l94.setTextFill(Color.BLACK);}
				if(typeErreur == "faux") {l94.setStyle("-fx-background-color: red;");}
				break;	
			}
		case 6:
			switch(colonne) {
			...
			case 9:
				if(typeErreur == "bon") {l95.setStyle("-fx-background-color: blue;");}
				if(typeErreur == "place") {l95.setStyle("-fx-background-color: yellow;");
					l95.setTextFill(Color.BLACK);}
				if(typeErreur == "faux") {l95.setStyle("-fx-background-color: red;");}
				break;	
			}
		}
	}
